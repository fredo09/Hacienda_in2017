...
<!--Aqui es la parte del cobro-->
  <div class="container" style="margin-top:10px;">
    <div class="row">
     ...
     <div class="jumbotron">
        <h1>Listado de los Cobros realizados</h1>
				<?php
						echo "<p>Corte de caja de la fecha.'$date'.</p>"
					?>
        <br>
     </div>
   </div>
	...
	<div class="row">
		<div class="col-md-12">
			<h1>Cobros realizados</h1>
					...
					<a href="?view=fecha_cobro" class="btn btn-warning">Corte de caja</a>
					<a href="?view=cobro" class="btn btn-warning">Regresar</a>
				<br><br>
...
*/
$cobro = $conexion->query("select * from cobro ORDER BY fecha DESC;");
?>
...
while($r=$cobro->fetch_object()):
	?>
<tr>
	<td><?php echo $r->idCobro;?></td>
	<td> $<?php echo $r->monto;?>.00</td>
	<td><?php echo $r->fecha; ?></td>
	<td><?php echo $r->hora; ?></td>
	<td style="width:260px;">
   <a href="?view=detalle-cobro&id=<?php echo $r->idCobro;?>"  class="btn btn-primary">Ver Detalle</a>
		</td>
</tr>
<?php endwhile; ?>
</table>
