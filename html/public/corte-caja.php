...
<!--Aqui es la parte del cobro-->
  <div class="container" style="margin-top:10px;">
    <div class="row">
     ...
     <div class="jumbotron">
        <h1>Corte de caja</h1>
        <p>El corte de caja se actualizara cada dia</p>
				<?php
...
*/
$products = $conexion->query("SELECT  * FROM cobro  WHERE fecha Like '%$date';");
$Total=0;//total de corte de caja
?>
...
<?php
//TOtal que muesta para el corte de caja
